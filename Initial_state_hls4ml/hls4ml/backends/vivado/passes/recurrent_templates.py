...
# original 
# recr_function_template = 'nnet::{recr_type}_stack<{input_t}, {output_t}, {config}>({input}, {initial_state}, {output}, {w}, {wr}, {b}, {br});'
...
class RecurrentConfigTemplate(LayerConfigTemplate):
    ...
    def format(self, node):
        ...
        # print("node", node)
        # print("dim", node.get_input_variable().dim_names)
        # print("n_in:", params['n_in'])
        # print("output dim", node.get_output_variable().dim_names)
        ...
        # print("act_config", act_config)
        recr_act_config = self.recr_act_template.format(**recr_act_params)
        # print("recr_act_config", recr_act_config)
