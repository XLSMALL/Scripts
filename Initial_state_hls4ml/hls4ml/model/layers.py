...
#         WeightAttribute('weight_GRU_1'),
#         WeightAttribute('bias_GRU_1'),
#         WeightAttribute('recurrent_weight_GRU_1'),
#         WeightAttribute('weight_GRU_2'),
#         WeightAttribute('bias_GRU_2'),
#         WeightAttribute('recurrent_weight_GRU_2'),

#         TypeAttribute('weight_GRU_1'),
#         TypeAttribute('bias_GRU_1'),
#         TypeAttribute('recurrent_weight_GRU_1'),
#         TypeAttribute('weight_GRU_2'),
#         TypeAttribute('bias_GRU_2'),
#         TypeAttribute('recurrent_weight_GRU_2')
#     ]

#     def initialize(self):
#         if self.attributes['layer']['config']['return_state']:
#             shape = [self.attributes['n_out_forward'] + self.attributes['n_out_backward']]
#             dims = ['N_OUT_FORWARD_{}'.format(self.index) + 'N_OUT_BACKWARD_{}'.format(self.index)]
#         else:
#             shape = [self.attributes['n_out_forward'] + self.attributes['n_out_backward']]
#             dims = ['N_OUT_FORWARD_{}'.format(self.index) + 'N_OUT_BACKWARD_{}'.format(self.index)]
