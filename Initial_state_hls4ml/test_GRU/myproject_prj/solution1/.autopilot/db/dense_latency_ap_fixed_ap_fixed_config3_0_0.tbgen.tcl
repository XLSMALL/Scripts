set moduleName dense_latency_ap_fixed_ap_fixed_config3_0_0
set isTopModule 0
...
set C_modelName {dense_latency<ap_fixed,ap_fixed,config3>.0.0}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.myproject_mul_16s_11s_26_2_0_U68", "Parent" : "0"}]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "data_0_V_read", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.myproject_mul_16s_12ns_26_2_0_U72", "Parent" : "0"}]}
