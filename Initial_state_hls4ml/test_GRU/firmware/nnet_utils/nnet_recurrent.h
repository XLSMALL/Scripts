...
template<class data_T, class res_T, typename CONFIG_T>
  void gru_stack(
    ...
    // std::cout << "output from data gru stack: " << std::endl;
    // nnet::print_result<res_T, CONFIG_T::n_sequence*CONFIG_T::n_in>(data, std::cout);
    // std::cout << " " << std::endl;

    // std::cout << "output from weight: " << std::endl;
    // nnet::print_result<res_T, CONFIG_T::n_state*3*CONFIG_T::n_in>(param, std::cout);
    // std::cout << " " << std::endl;
    }
