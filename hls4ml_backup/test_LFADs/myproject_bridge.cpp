...
void myproject_float(
    ...
    float layer13_out[N_OUTPUTS_13*N_FILT_13]
) {
    
    input_t input_1_ap[N_INPUT_1_1*N_INPUT_2_1];
    nnet::convert_data<float, input_t, N_INPUT_1_1*N_INPUT_2_1>(input_1, input_1_ap);

    result_t layer13_out_ap[N_OUTPUTS_13*N_FILT_13];

    myproject(input_1_ap,layer13_out_ap);

    nnet::convert_data<result_t, float, N_OUTPUTS_13*N_FILT_13>(layer13_out_ap, layer13_out);
}

void myproject_double(
    double input_1[N_INPUT_1_1*N_INPUT_2_1],
    double layer13_out[N_OUTPUTS_13*N_FILT_13]
) {
    input_t input_1_ap[N_INPUT_1_1*N_INPUT_2_1];
    ...
    nnet::convert_data<result_t, double, N_OUTPUTS_13*N_FILT_13>(layer13_out_ap, layer13_out);
}
