  ...
  if (fin.is_open() && fpr.is_open()) {
    while ( std::getline(fin,iline) && std::getline (fpr,pline) ) {
      ...
      if (e % CHECKPOINT == 0) {
        ...
        nnet::print_result<result_t, N_LAYER_1_3*N_LAYER_2_3>(layer3_out, std::cout, true);
      }
      e++;

      //hls-fpga-machine-learning insert tb-output
      nnet::print_result<result_t, N_LAYER_1_3*N_LAYER_2_3>(layer3_out, fout);
