...
#weights & bias add
bidir_function_template = 'nnet::bidirectional<{input_t}, {output_t}, {config}>({input}, {output}, {wb_1}, {wrb_1}, {b_b},{wf_2},{wrf_2}, {b_f});'
...
class BidirectionalConfigTemplate(LayerConfigTemplate):
    ...
    def format(self, node):
        ...
        if node.get_attr('return_sequences'):
            ...
            flayer_params['n_sequence_out'] = 1
            flayer_params['n_state'] = node.get_output_variable().dim_names[0]
            flayer_params['n_out'] = node.get_output_variable().dim_names[0]
        ...
        if node.get_attr('return_sequences'):
            ...
            blayer_params['n_sequence_out'] = 1
            blayer_params['n_state'] = node.get_output_variable().dim_names[0]
            blayer_params['n_out'] = node.get_output_variable().dim_names[0]
