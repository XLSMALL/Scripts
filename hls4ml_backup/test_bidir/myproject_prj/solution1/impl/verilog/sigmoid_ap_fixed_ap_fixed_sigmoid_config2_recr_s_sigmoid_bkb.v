...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module sigmoid_ap_fixed_ap_fixed_sigmoid_config2_recr_s_sigmoid_bkb_rom (
...
initial begin
    $readmemh("./sigmoid_ap_fixed_ap_fixed_sigmoid_config2_recr_s_sigmoid_bkb_rom.dat", ram0);
    $readmemh("./sigmoid_ap_fixed_ap_fixed_sigmoid_config2_recr_s_sigmoid_bkb_rom.dat", ram1);
    $readmemh("./sigmoid_ap_fixed_ap_fixed_sigmoid_config2_recr_s_sigmoid_bkb_rom.dat", ram2);
    $readmemh("./sigmoid_ap_fixed_ap_fixed_sigmoid_config2_recr_s_sigmoid_bkb_rom.dat", ram3);
end
...
`timescale 1 ns / 1 ps
module sigmoid_ap_fixed_ap_fixed_sigmoid_config2_recr_s_sigmoid_bkb(
    reset,
    clk,
    address0,
    ce0,
...
sigmoid_ap_fixed_ap_fixed_sigmoid_config2_recr_s_sigmoid_bkb_rom sigmoid_ap_fixed_ap_fixed_sigmoid_config2_recr_s_sigmoid_bkb_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
