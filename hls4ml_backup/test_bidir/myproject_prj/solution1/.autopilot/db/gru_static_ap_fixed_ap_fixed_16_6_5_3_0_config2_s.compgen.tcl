...
set id 188
set name myproject_mul_mul_17s_16s_26_3_1
set corename simcore_mul
set op mul
set stage_num 3
set max_latency -1
...
set out_width 26
set exp i0*i1
set arg_lists {i0 {17 1 +} i1 {16 1 +} p {26 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
...
set id 192
set name myproject_mac_muladd_16s_16s_26s_26_3_1
...
set out_width 26
set exp i0*i1+i2
set arg_lists {i0 {16 1 +} i1 {16 1 +} m {26 1 +} i2 {26 1 +} p {26 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
